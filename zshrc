...
# Path to your oh-my-zsh installation.
  export ZSH=/home/spichugi/.oh-my-zsh
...
#
# Name the window for Java applications
wmname LG3D

# Set vim bindings in the terminal
set -o vi

feh --bg-scale /home/spichugi/Pictures/diving.jpg

bindkey "^R" history-incremental-search-backward

setxkbmap us,ru -option grp:menu_toggle,grp:caps_toggle
